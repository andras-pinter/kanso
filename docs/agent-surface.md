...
| Set card body                  | `PUT /cards/:id/body`                           | `card_body_set`                      | `card_body_set`                            | `card_body_set`                            | `CardBodyStampDto {id, updated_at}`                          | Returns tiny stamp so agents can observe write timestamp (Phase 4b). |
...
| `PUT /cards/:id/body`                   | `CardBodyStampDto {id, updated_at}`|
